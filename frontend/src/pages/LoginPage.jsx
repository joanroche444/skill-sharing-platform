...
function Login() {
  ...
  const handleOAuthLogin = (provider) => {
    if (provider === 'Google') {
      ...
      // Add GitHub OAuth URL when configured
      console.log('GitHub login not yet configured');
    } else if (provider === 'Facebook') {
      // Add Facebook OAuth URL when configured
      console.log('Facebook login not yet configured');
    }
  };
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center">
        <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full text-center">
          ...
          <div className="mt-4 flex justify-center">
            <div className="w-12 h-1 rounded-full bg-indigo-600 animate-pulse"></div>
          </div>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center">
          <Link to="/" className="flex items-center text-indigo-600 hover:text-indigo-500 transition-colors">
